...
let Simple/Codeintel-db = ../../../../simple/codeintel-db/package.dhall

let name = "codeintel-db"
...
let Container/pgsql/generate
    ...
    = λ(c : Configuration/Internal/Container/pgsql) →
        ...
        let simpleLiveness = Simple/Codeintel-db.Containers.pgsql.HealthCheck
        ...
        let port = Simple/Codeintel-db.Containers.pgsql.ports.database
...
let Deployment/generate
    ...
    = λ(c : Configuration/Internal/Deployment) →
        ...
        let deploymentLabels =
              toMap (deploySourcegraphLabel ∧ noClusterAdminLabel)
              ...
              Some
                (   [ Kubernetes/Volume::{
                      ...
                      , persistentVolumeClaim = Some Kubernetes/PersistentVolumeClaimVolumeSource::{
                        , claimName =
                            c.Volumes.disk.persistentVolumeClaim.claimName
                        }
                      }
                    , Kubernetes/Volume::{
